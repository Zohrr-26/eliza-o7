...
with st.sidebar:
    ...
    if st.button("Prediction"):
        prediction_url = "https://eliza-functionapp.azurewebsites.net/api/predict"
    ...
    history_url = "https://eliza-functionapp.azurewebsites.net/api/history"
    ...
    try: 
        ...
        if resp.status_code == 200:
            ...
            for row in data.get('history', []):
                locality_data = int(row['locality']) - 1
